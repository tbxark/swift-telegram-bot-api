...
extension TelegramAPI {
    ...
    */
    public class ReplyParameters: Codable {
        ...
        public init(message_id: Int, chat_id: Either2<Int, String>? = nil, allow_sending_without_reply: Bool? = nil, quote: String? = nil, quote_parse_mode: String? = nil, quote_entities: Array<MessageEntity>? = nil, quote_position: Int? = nil, checklist_task_id: Int? = nil) {
            self.message_id = message_id
...
extension TelegramAPI {
    ...
    */
    public class Video: Codable {
        ...
        public init(file_id: String, file_unique_id: String, width: Int, height: Int, duration: Int, thumbnail: PhotoSize? = nil, cover: Array<PhotoSize>? = nil, start_timestamp: Int? = nil, file_name: String? = nil, mime_type: String? = nil, file_size: Int? = nil) {
            self.file_id = file_id
            self.file_unique_id = file_unique_id
            self.width = width
            self.height = height
...
extension TelegramAPI {
    ...
    */
    public class ChecklistTask: Codable {
        ...
        public let text_entities: Array<MessageEntity>?
        /** User | Optional. User that completed the task; omitted if the task wasn't completed */
        ...
        public init(id: Int, text: String, text_entities: Array<MessageEntity>? = nil, completed_by_user: User? = nil, completion_date: Int? = nil) {
            self.id = id
            self.text = text
            self.text_entities = text_entities
...
extension TelegramAPI {
    ...
    */
    public class InputChecklistTask: Codable {
        ...
        /** Array of MessageEntity | Optional. List of special entities that appear in the text, which can be specified instead of parse_mode. Currently, only bold, italic, underline, strikethrough, spoiler, and custom_emoji entities are allowed. */
        public let text_entities: Array<MessageEntity>?
...
extension TelegramAPI {
    ...
    */
    public class InputChecklist: Codable {
        ...
        public let parse_mode: String?
        /** Array of MessageEntity | Optional. List of special entities that appear in the title, which can be specified instead of parse_mode. Currently, only bold, italic, underline, strikethrough, spoiler, and custom_emoji entities are allowed. */
        public let title_entities: Array<MessageEntity>?
...
extension TelegramAPI {
    ...
    */
    public class ChatMemberAdministrator: Codable {
        ...
        public init(status: String, user: User, can_be_edited: Bool, is_anonymous: Bool, can_manage_chat: Bool, can_delete_messages: Bool, can_manage_video_chats: Bool, can_restrict_members: Bool, can_promote_members: Bool, can_change_info: Bool, can_invite_users: Bool, can_post_stories: Bool, can_edit_stories: Bool, can_delete_stories: Bool, can_post_messages: Bool? = nil, can_edit_messages: Bool? = nil, can_pin_messages: Bool? = nil, can_manage_topics: Bool? = nil, can_manage_direct_messages: Bool? = nil, custom_title: String? = nil) {
            self.status = status
            self.user = user
...
extension TelegramAPI {
    ...
    */
    public class Gift: Codable {
        ...
        public init(id: String, sticker: Sticker, star_count: Int, upgrade_star_count: Int? = nil, total_count: Int? = nil, remaining_count: Int? = nil, publisher_chat: Chat? = nil) {
            self.id = id
            self.sticker = sticker
            self.star_count = star_count
...
extension TelegramAPI {
    ...
    */
    public class UniqueGift: Codable {
        ...
        public init(base_name: String, name: String, number: Int, model: UniqueGiftModel, symbol: UniqueGiftSymbol, backdrop: UniqueGiftBackdrop, publisher_chat: Chat? = nil) {
...
extension TelegramAPI {
    ...
    */
    public class GiftInfo: Codable {
        ...
        /** Integer | Optional. Number of Telegram Stars that were prepaid by the sender for the ability to upgrade the gift */
        ...
        public init(gift: Gift, owned_gift_id: String? = nil, convert_star_count: Int? = nil, prepaid_upgrade_star_count: Int? = nil, can_be_upgraded: Bool? = nil, text: String? = nil, entities: Array<MessageEntity>? = nil, is_private: Bool? = nil) {
            self.gift = gift
...
extension TelegramAPI {
    ...
    */
    public class UniqueGiftInfo: Codable {
        ...
        /** String | Origin of the gift. Currently, either "upgrade" for gifts upgraded from regular gifts, "transfer" for gifts transferred from other users or channels, or "resale" for gifts bought from other users */
        public let origin: String
        /** Integer | Optional. For gifts bought from other users, the price paid for the gift */
        public let last_resale_star_count: Int?
        /** String | Optional. Unique identifier of the received gift for the bot; only present for gifts received on behalf of business accounts */
        public let owned_gift_id: String?
        ...
        public init(gift: UniqueGift, origin: String, last_resale_star_count: Int? = nil, owned_gift_id: String? = nil, transfer_star_count: Int? = nil, next_transfer_date: Int? = nil) {
            self.gift = gift
            self.origin = origin
...
extension TelegramAPI {
    ...
    */
    public class OwnedGiftRegular: Codable {
        ...
        public let was_refunded: Bool?
        /** Integer | Optional. Number of Telegram Stars that can be claimed by the receiver instead of the gift; omitted if the gift cannot be converted to Telegram Stars */
        public let convert_star_count: Int?
        /** Integer | Optional. Number of Telegram Stars that were paid by the sender for the ability to upgrade the gift */
        public let prepaid_upgrade_star_count: Int?

        public init(type: String, gift: Gift, owned_gift_id: String? = nil, sender_user: User? = nil, send_date: Int, text: String? = nil, entities: Array<MessageEntity>? = nil, is_private: Bool? = nil, is_saved: Bool? = nil, can_be_upgraded: Bool? = nil, was_refunded: Bool? = nil, convert_star_count: Int? = nil, prepaid_upgrade_star_count: Int? = nil) {
            self.type = type
            self.gift = gift
            self.owned_gift_id = owned_gift_id
            self.sender_user = sender_user
...
extension TelegramAPI {
    ...
    */
    public class AcceptedGiftTypes: Codable {
        ...
        public init(unlimited_gifts: Bool, limited_gifts: Bool, unique_gifts: Bool, premium_subscription: Bool) {
...
extension TelegramAPI {
    ...
    public struct ForwardMessageParams: Codable {
        ...
        public init(chat_id: Either2<Int, String>, message_thread_id: Int? = nil, direct_messages_topic_id: Int? = nil, from_chat_id: Either2<Int, String>, video_start_timestamp: Int? = nil, disable_notification: Bool? = nil, protect_content: Bool? = nil, suggested_post_parameters: SuggestedPostParameters? = nil, message_id: Int) {
            self.chat_id = chat_id
            self.message_thread_id = message_thread_id
            self.direct_messages_topic_id = direct_messages_topic_id
...
extension TelegramAPI {
    ...
    public struct SendPaidMediaParams: Codable {
        ...
        /** Integer | Identifier of the direct messages topic to which the message will be sent; required if the message is sent to a direct messages chat */
        public let direct_messages_topic_id: Int?
        /** Integer | The number of Telegram Stars that must be paid to buy access to the media; 1-10000 */
        public let star_count: Int
...
extension TelegramAPI {
    ...
    public struct PromoteChatMemberParams: Codable {
        ...
        public init(chat_id: Either2<Int, String>, user_id: Int, is_anonymous: Bool? = nil, can_manage_chat: Bool? = nil, can_delete_messages: Bool? = nil, can_manage_video_chats: Bool? = nil, can_restrict_members: Bool? = nil, can_promote_members: Bool? = nil, can_change_info: Bool? = nil, can_invite_users: Bool? = nil, can_post_stories: Bool? = nil, can_edit_stories: Bool? = nil, can_delete_stories: Bool? = nil, can_post_messages: Bool? = nil, can_edit_messages: Bool? = nil, can_pin_messages: Bool? = nil, can_manage_topics: Bool? = nil, can_manage_direct_messages: Bool? = nil) {
            self.chat_id = chat_id
            self.user_id = user_id
            self.is_anonymous = is_anonymous
            self.can_manage_chat = can_manage_chat
...
extension TelegramAPI {
    ...
    public struct GetBusinessAccountGiftsParams: Codable {
        ...
        /** Boolean | Pass True to exclude gifts that can be purchased a limited number of times */
        public let exclude_limited: Bool?
        ...
        public init(business_connection_id: String, exclude_unsaved: Bool? = nil, exclude_saved: Bool? = nil, exclude_unlimited: Bool? = nil, exclude_limited: Bool? = nil, exclude_unique: Bool? = nil, sort_by_price: Bool? = nil, offset: String? = nil, limit: Int? = nil) {
            self.business_connection_id = business_connection_id
